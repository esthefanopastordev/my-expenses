...
class AddTransactionViewController: UIViewController {
    ...
    @IBAction func doneTapped(_ sender: UIBarButtonItem) {
        ...
        let newTransaction = Transaction(id: "0ffd4eaa-09a1-4846-87b4-07a683fd2975", name: name, amount: 10.00, date: Date(), categoryId: "", type: type.lowercased(), description: "", images: [""])
